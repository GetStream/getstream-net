...
namespace GetStream
{
    ...
    public class StreamOptions
    {
        ...
        /// <summary>How long an idle pooled connection lingers. Default <c>55s</c>
        /// (5s below the typical 60s LB idle timeout).</summary>
        ...
        /// <summary>Per-request timeout applied to <see cref="HttpClient.Timeout"/>. Default <c>30s</c>.
