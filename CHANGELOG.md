...
Entries after 16.0.1 are generated by release-please from commit messages; earlier
ones were written by hand in the [Keep a Changelog](https://keepachangelog.com/en/1.0.0/)
format.

## [16.0.2](https://github.com/GetStream/getstream-net/compare/v16.0.1...v16.0.2) (2026-09-17)


### Bug Fixes

* **test:** give deleted users unique names and allow slower tasks ([#80](https://github.com/GetStream/getstream-net/issues/80)) ([a8b43b6](https://github.com/GetStream/getstream-net/commit/a8b43b6f76e5ed83ab098ea8198fb8bf3d383dbb))

## [16.0.1] - 2026-09-15

### Fixed

- Test-only: the file-upload integration test uploaded a `.tmp` file the test app does not allow (#77).
...
Re-release of 15.3.0 after a failed release run; no source changes.
...
- Regenerated from chat v235.17.1.

## [15.1.0] - 2026-08-12

### Fixed

- Name the HTTP status when the error body is not JSON (#68).
