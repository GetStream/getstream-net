...
( cd $SOURCE_PATH ; make openapi; make -C tools/openapi build; ./build/openapi generate-client --language dotnet --spec ./releases/v2/serverside-api.yaml --output $DST_PATH )

# Generate webhook conformance fixtures
( cd $SOURCE_PATH ; ./build/openapi generate-webhook-fixtures --output ../getstream-net/tests/fixtures/webhooks )
